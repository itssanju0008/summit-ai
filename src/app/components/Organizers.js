const organizers = [
 ...
 image: '/images/logos/iitdlogo.png',
  ...
  },
  {
    ...
    description: "Driving AI innovation and digital solutions for inclusive growth across all communities.",
    image: '/images/logos/iitdlogo.png',
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-sm md:text-lg text-gray-700 max-w-3xl mx-auto px-4">
            A collaborative effort bringing together government agencies, tribal organizations, 
            and technology leaders to create meaningful change.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex items-start gap-3 sm:gap-4 md:gap-6 mb-4 md:mb-6">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <h3 className="text-base sm:text-lg md:text-lg font-serif font-bold text-gray-900 break-words">{org.name}</h3>
                  </div>
                </div>

                {/* Description */}
                <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">{org.description}</p>
              </div>
            );
          })}
        </div>
